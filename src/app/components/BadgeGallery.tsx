...
export function BadgeGallery() {
  ...
  const badges = [
    ...
    },
    {
      ...
      icon: "✅",
      progress: storedProgress.completeness || 0,
      goal: 1,
      unlocked: (storedProgress.completeness || 0) >= 1,
    },
    {
      id: 14,
      ...
      progress: storedProgress.completeness || 0,
      goal: 5,
      unlocked: (storedProgress.completeness || 0) >= 5,
    },
    {
      id: 15,
      ...
      progress: storedProgress.completeness || 0,
      goal: 10,
      unlocked: (storedProgress.completeness || 0) >= 10,
    },
    {
      id: 16,
      name: "Reply Master I",
      ...
      icon: "📨",
      progress: storedProgress.replyMaster || 0,
      goal: 5,
      unlocked: (storedProgress.replyMaster || 0) >= 5,
    },
    {
      id: 17,
    ...
    },
    {
      ...
      icon: "🏗️",
      progress: storedProgress.structure || 0,
      goal: 1,
      unlocked: (storedProgress.structure || 0) >= 1,
    },
    {
      id: 23,
      ...
      progress: storedProgress.structure || 0,
      goal: 5,
      unlocked: (storedProgress.structure || 0) >= 5,
    },
    {
      id: 24,
      ...
      progress: storedProgress.structure || 0,
      goal: 10,
      unlocked: (storedProgress.structure || 0) >= 10,
    },
    {
      id: 25,
      ...
      icon: "⚡",
      progress: storedProgress.timeliness || 0,
      goal: 1,
      unlocked: (storedProgress.timeliness || 0) >= 1,
    },
    {
      id: 26,
      ...
      progress: storedProgress.timeliness || 0,
      goal: 5,
      unlocked: (storedProgress.timeliness || 0) >= 5,
    },
    {
      id: 27,
      ...
      progress: storedProgress.timeliness || 0,
      goal: 10,
      unlocked: (storedProgress.timeliness || 0) >= 10,
    },
  ];
      ...
      <div className="w-full max-w-5xl px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {badges.map((badge) => (
            <div
              key={badge.id}
              className={`flex flex-col items-center p-8 rounded-xl border-2 border-black bg-white shadow-md transition-all ${
                badge.unlocked ? "" : "opacity-60"
              }`}
            >
              <div
                className={`w-28 h-28 flex items-center justify-center text-6xl mb-4 border-2 border-black rounded-full ${
                  badge.unlocked
                    ? "bg-[#ec78b8] text-white"
